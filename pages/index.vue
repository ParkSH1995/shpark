  ...
  <section>
    ...
    <div class="container">
      <section id="about" class="col-m-12 col-p-12">
        ...
        <div>
          <p>
            2018년부터 Front-End 개발을 하고 있는 박상현입니다.<br/>
            Vue.js를 이용한 Front-End 개발에 관해 관심이 많으며 반응형 웹과 사용자 인터랙션에도 관심을 두고 있습니다.<br/>
            주로 사용하는 언어는 HTML, CSS, JavaScript 입니다.<br/>
          </p>
          <div class="flex flex-ai-center div-more-infomation">
            <a class="btn btn-primary btn-resume" href="https://www.naver.com/">이력서 보러가기 <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </section>
  ...
  data () {
    return {
      ...
      paCards: [
        ...
        {
          'date': '2017.08 - 현재',
          'title': 'Park Perosnal 1',
          'img': '/pa/djangocon-logo.png',
          'contents': [
            '<strong>박상현의 포트폴리오2</strong>',
            '- 행사준비',
            '- 안내사이트 제작',
        ...
        {
          'date': '2017.07 - 현재',
          'title': 'Park Perosnal 2',
          'img': '/pa/vue-lunar-calendar.png',
          'contents': [
            '<strong>박상현의 포트폴리오 프로젝트</strong>',
        ...
        {
          'date': '2017.12',
          'title': 'Park Perosnal 4',
          'img': '/pa/doit-vue-js.png',
          'contents': [
            '<strong>vue.js 박상현의 포트폴리오 프로젝트</strong>',
            '서명: 박상현의 포트폴리오 프로젝트',
            '저자: 장기효',
        ...
        },
        {
          ...
          'contents': [
            '<strong>박상현의 포트폴리오 프로젝트 스태프</strong>',
            '- 박상현의 포트폴리오 프로젝트 안내사이트 제작 참여',
        ...
        },
        {
          ...
          'img': '/pa/9xd-1.jpg',
          'contents': [
            '<strong>박상현의 포트폴리오 프로젝트 9XD</strong>',
            '- Vue.js 전파',
            '- 팀 주제: 아트',
            '- 아트 프로젝트 발표'
          ]
        ...
        },
        {
          ...
          'img': '/pa/vuejs-kr.png',
          'contents': [
            '<strong>vue.js Korea 박상현의 프로젝트</strong>'
          ]
        },
        {
          'date': '2017.07',
